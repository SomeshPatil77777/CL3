...
# Function to perform Difference operation on fuzzy sets (A - B)
def fuzzy_difference(A, B):
    return np.minimum(A, 1 - B)  # Correct logic for fuzzy difference
...
composition_result = max_min_composition(cartesian_result, np.identity(3))
